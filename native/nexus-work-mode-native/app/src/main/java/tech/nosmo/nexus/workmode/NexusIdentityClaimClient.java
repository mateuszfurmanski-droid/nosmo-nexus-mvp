        ...
        new Thread(() -> {
            ...
            try {
                ...
                if (status == 201 && body.optBoolean("bound", false)) {
                    callback.onComplete(true, status, "Canonical Nexus Person bound to this authenticated session");
                } else {
                ...
                callback.onComplete(false, 0, "Could not reach Nexus identity claim service");
            } finally {
