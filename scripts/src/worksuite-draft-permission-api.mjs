...
const DEMO_ACTOR_FIXTURE_HEADER = "x-nexus-demo-actor-fixture";
...
function statusPayload() {
  return {
    ...
    demoActorFixtureHeader: DEMO_ACTOR_FIXTURE_HEADER,
...
async function handleValidate(request, response) {
  try {
    ...
    const actorContext = resolveActorContext(request, body.actorContext);
