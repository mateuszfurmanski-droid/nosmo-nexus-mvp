...
// Legacy e-SAFE material is retained only as provenance inside the canonical project.
assertManifestContains('role: "legacySourceLibrary"', "legacy source library must be explicitly non-canonical provenance");
...
// Compatibility facade may keep global Android review folders, but project-world
// IDs must be derived from the canonical manifest rather than duplicated.
