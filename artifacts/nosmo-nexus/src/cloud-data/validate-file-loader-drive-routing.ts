...
const riversideAlias = resolveNexusGoogleDriveProjectRouteFromAlias("riverside");
assert(riversideAlias?.route.projectId === "RIVERSIDE_DEMO_PROJECT", "existing Riverside Android alias must survive reconciliation");
