...
} from "../lib/nexus-person-work-profile-persistence";
...
router.post("/nexus/person/onboarding/invites", async (req, res) => {
  if (!isAuthed(req)) {
...
router.post("/nexus/person/onboarding/claim", async (req, res) => {
...
router.post("/nexus/person/onboarding/drafts/load", async (req, res) => {
...
router.post("/nexus/person/onboarding/drafts/save", async (req, res) => {
  let authority: { inviteId: string; personId: string } | null;
  try {
    authority = requireDraftAuthority(req);
  } catch (error) {
