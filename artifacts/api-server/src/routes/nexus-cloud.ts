...
import {
  createNexusCloudPendingAssetEnvelope,
  type NexusCloudSourceModule,
} from "../../../../src/core/storage/cloudAssetContract";
...
const handleCloudFileUpload = (sourceModule: NexusCloudSourceModule) =>
...
// Provenance is selected only by the server-owned route. Clients never submit sourceModule.
router.post("/files", parseSingleFile, handleCloudFileUpload("file-loader"));
router.post("/android/files", parseSingleFile, handleCloudFileUpload("android-work-mode"));
