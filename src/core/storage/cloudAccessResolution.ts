...
import {
  ...
  type NexusModuleEntitlementAccessView,
 ...
 * server-owned Person/Participation/Permission access views and always evaluates
 * the exact `cloud.file.write` action. The result can be passed directly to the
